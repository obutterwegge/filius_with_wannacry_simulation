...
public class DNSNachricht {
	 ...
	 * <li>1 - Format error - The name server was unable to interpret the query.
	 * </li>
	 * <li>2 - Server failure - The name server was unable to process this query
	 * due to a problem with the name server.</li>
