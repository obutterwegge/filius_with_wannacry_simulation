 ...
 * <ol>
 * <li>QNAME a domain name represented as a sequence of labels, where each label
...
public class Query {
	...
	/**
	 * QTYPE a code which specifies the type of the query. Zur Belegung dieses
	 * Attributs sollten die entsprechenden Konstanten der Klasse DNSNachricht
	 * verwendet werden
	 */
	private String qtype = null;

	/**
	 * QCLASS a code that specifies the class of the query. For example, the
	 ...
	 * toString() erzeugt wurde, wieder eine Query erstellt.
	 * 
	 * @param nachricht
	...
	public Query(String query) {
		Main.debug
		        .println("INVOKED (" + this.hashCode() + ") " + getClass() + " (Query), constr: Query(" + query + ")");
	...
	/**
	 * Methode zum Abruf einer Anfrage (query). Das Rueckgabeformat ist NAME
	 * TYPE CLASS (Bsp.: web.de. A IN)
	 */
