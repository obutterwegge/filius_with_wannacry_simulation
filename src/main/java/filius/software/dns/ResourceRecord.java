 ...
 * <li>TYPE two octets containing one of the RR type codes. This field specifies
 * the meaning of the data in the RDATA field.</li>
 ...
 * <li>RDATA a variable length string of octets that describes the resource. The
...
public class ResourceRecord {
	...
	/**
	 * TYPE two octets containing one of the RR type codes. This field specifies
	 * the meaning of the data in the RDATA field. Zur Belegung dieses Attributs
	 * sollten die entsprechenden Konstanten verwendet werden
	 */
	...
	/**
	 * RDATA a string that describes the resource. The format of this
	 * information varies according to the TYPE and CLASS of the resource
	 ...
	 * toString() erzeugt wurde, wieder einen Resource-Record erstellt.
	 * 
	 * @param nachricht
	...
	/**
	 * Diese Methode liefert einen Resource Record als String zurueck. Methode
	 * zum Abruf eines Resource Record. Das Rueckgabeformat ist NAME TYPE CLASS
	 * TTL RDATA (Bsp. web.de. A IN 3600 217.72.195.42)
	 */
